...
public class MainActivity extends AppCompatActivity {
    ...
    private final String CRYPTOCURRENCY = "BTC";

    private final String FINAL_URL=BASE_URL+CRYPTOCURRENCY;
    ...
    private void letsDoSomeNetworking(final String currency) {
        ...
        client.get(FINAL_URL+currency, new JsonHttpResponseHandler() {
